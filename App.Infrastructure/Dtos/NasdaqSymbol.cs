...
namespace App.Infrastructure.Dtos
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NasdaqSymbol"/> class.
        /// </summary>
        ...
        public NasdaqSymbol(string symbol, string securityName, char marketCategory, bool testIssue, char financialStatus, int roundLotSize, bool etf, bool nextShares)
        {
            this.Symbol = symbol;
