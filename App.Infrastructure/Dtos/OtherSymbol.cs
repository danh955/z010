...
namespace App.Infrastructure.Dtos
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OtherSymbol"/> class.
        /// </summary>
        ...
        public OtherSymbol(string actSymbol, string securityName, char exchange, string cqsSymbol, bool etf, int roundLotSize, bool testIssue, string nasdaqSymbol)
        {
